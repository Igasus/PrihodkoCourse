...
namespace PrihodkoCourse.Migrations
{
    ...
    [Migration("20210108072720_InitWithRecipeMedicament")]
    partial class InitWithRecipeMedicament
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PrihodkoCourse.Models.RecipeMedicament", b =>
                {
                    ...
                    b.HasKey("RecipeId", "MedicamentId");

                    b.HasIndex("MedicamentId");

                    b.ToTable("RecipesMedicaments");
                });
            ...
            modelBuilder.Entity("PrihodkoCourse.Models.RecipeMedicament", b =>
                {
                    ...
                    b.HasOne("PrihodkoCourse.Models.Recipe", "Recipe")
                        .WithMany("RecipeMedicaments")
